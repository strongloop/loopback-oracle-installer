...
Thank you for your interest in `loopback-oracle-installer`, an open source project
administered by StrongLoop.

Contributing to `loopback-oracle-installer` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-oracle-installer)
